...
constexpr double BOND_STRENGTH = static_cast<double>(NDIMS);
constexpr double BOND_LENGTH = 0.0;
...
// constexpr double SYS_SKIN = WCA_CUTOFF / 2;
// constexpr double SYS_CUTOFF = WCA_CUTOFF + SYS_SKIN;
constexpr double SYS_SKIN = Inf;
constexpr double SYS_CUTOFF = 0.0;
...
int main(int argc, char* argv[]) {
    ...
    // line arguments
    double activity = 0.0;
    [[maybe_unused]] double stiffness = 0.0;
